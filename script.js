...
function switchTAB() {
	...
	if(i%2 == 0) {
		document.getElementById("list-switch").style= "display: grid; height: 50vh; margin-left: 2%;";
		document.getElementById("search-switch").style= "display: block; margin-left: 1%;";
	}else {
